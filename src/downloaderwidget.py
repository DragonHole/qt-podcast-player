...
from PySide6.QtCore import QStandardPaths, QUrl, QFile, QSaveFile, QDir, QIODevice, Slot, Signal, QXmlStreamReader
from PySide6.QtNetwork import QNetworkReply, QNetworkRequest, QNetworkAccessManager

class DownloaderWidget(QWidget):
    """A widget to download a http file to a destination file"""

    sendSelectedFilePathSignal = Signal(str)
    ...
    def on_start(self):
        ...
        if url_file == "":
            QMessageBox.warning(self, "hello world", "URL can't be empty", QMessageBox.Yes | QMessageBox.No)
            return 
        ...
        self.xml_file_read = QFile(dest_file)
    ...
    def onSendFilepathSignal(self):
        ...
        self.sendSelectedFilePathSignal.emit(dest_file)
